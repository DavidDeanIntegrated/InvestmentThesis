...
- **Portfolio dashboard** — Home page with Chart.js doughnut chart, live market prices from Finnhub, SPY drawdown monitor, deployment ladder, and rebalancing rules
